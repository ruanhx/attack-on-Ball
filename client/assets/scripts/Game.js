...
var Game = cc.Class({
    ...
    spawnNewStar: function() {
        ...
        if (this.currentStarX >= 0) {
            var randSpeedX = -cc.random0To1() * maxX;
        }else{
            randSpeedX = cc.random0To1() * maxX;
        }
        var randSpeedY = -cc.random0To1() * maxY;
        newStar.getComponent('Star').setSpeed(randSpeedX,randSpeedY,this.groundY,this.node.height/2);
